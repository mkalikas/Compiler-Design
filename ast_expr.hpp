...
// The expressions defined below take operands of type bool and their result
// type is bool
...
// operand e1 is converted to bool, if e2 and e3 have the same type, then no
...
struct Cond_expr : Expr {
  ...
  Cond_expr(Expr *e1, Expr *e2, Expr *e3, Type *t)
      : e1(e1), e2(e2), e3(e3), t(t) {}
  void accept(Visitor &v) { v.visit(this); }
};

// The following expressions take operands of type integer. The result type of
// the expression is bool.
...
struct Greater_orEqual_expr : Expr {
  Expr *e1;
  Expr *e2;
  Type *t Greater_orEqual_expr(Expr *e1, Expr *e2, Type *t)
      : e1(e1), e2(e2), t(t) {}
  void accept(Visitor &v) override { v.visit(this); }
};

// The expressions defined below take operands that are of type integer and
// their result type is integer
...
struct Function_call_expr : Expr {
  ...
  // fits the form: e(e1, e2, e3,...en) where e is the callee and e1, e2,
  // e3,...en are the arguments the called function has to have the same number
  // of parameters as the function call
  Expr *function;
  std::std::vector<Expr *> args;
  // the called function has to have the same number of parameters as the
  // function call
